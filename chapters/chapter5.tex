...
\begin{definition}[Partie réelle et partie imaginaire]
    ...
    \begin{align*}
        &\Re(z) = \Operatorname{Re}(z) = a \text{ (Partie réelle)} \\
        &\Im(z) = \Operatorname{Im}(z) = b \text{ (Partie imaginaire)}
    \end{align*}
\end{definition}
...
\begin{definition}[Formule de Moivre]
    \begin{align*}
...
\begin{definition}[Identité d'Euler]
    \begin{align*}
        e^{i \pi} = -1
    \end{align*}
\end{definition}

\begin{definition}[Formules d'Euler]
    \begin{align*}
